...
public class CrossesZeroesApp {
    ...
    public static void initMap() {
        ...
        for (int i = 0; i < map.length; i++) {
            ...
            //Arrays.fill(map[i], DOT_EMPTY); - тоже самое, но проще писать (библиотечный метод заполнения массива)
        }
    }

    /**
     * Вывод игровог поля на экран.
     */
     ...
     */
    public static boolean checkWin(char symbol) { //проверка победы условиями
        //строки
